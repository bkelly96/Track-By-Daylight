drop database if exists Track_By_Daylight_test;
create database Track_By_Daylight_test;
...
begin
    ...
    delete from survivor_add_on;
    alter table survivor_add_on auto_increment = 1;
    delete from survivor_item;
    alter table survivor_item auto_increment = 1;
    delete from survivor_perk;
    alter table survivor_perk auto_increment = 1;
    delete from survivor_offering;
    alter table survivor_offering auto_increment = 1;
    delete from killer_add_on;
    alter table killer_add_on auto_increment = 1;
    delete from killer_perk;
    alter table killer_perk auto_increment = 1;
    delete from killer_offering;
    alter table killer_offering auto_increment = 1;
    delete from killer;
	...
	delete from add_on;
    alter table add_on auto_increment = 1;
    delete from item;
